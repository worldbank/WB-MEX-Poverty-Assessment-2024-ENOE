...
*<_whours_>
/*<_whours_note>
Variables of importance. Changes for Q3 of 2006
...
p5d_thrs – In reference to the previous question, what days and how many hours do you usually work?

for a matter of simplicity please check thw questionnaire to get the full detail of each variable

we are taking question p5c and p5d to construct the whours because both complement each other
...
*replace if usually it happens the same this season (4) and if you consider this will not last (5)
	replace whours=p5d_thrs if inrange(p5b,4,5)
*replace with usual hours if they declare that not the usual hours in p5d
	replace whours=p5d_thrs if p5d==2
...
*replace if not the usual hours in the week
	replace whours=p5d_thrs if p5==2
...
/*<_union_> Does not have this variable on Basic Questionnaire for Q3 of 2006
