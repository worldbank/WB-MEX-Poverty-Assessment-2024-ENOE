...
<_Program name_>				[MEX_2015_ENOE_V01_M_V06_A_GLD_ALL.do] </_Program name_>
...
<_Sample size (HH)_> 			[107,708] </_Sample size (HH)_>
<_Sample size (IND)_> 			[396,812] </_Sample size (IND)_>
...
*Note: the dta. 2015- onwards have in var p3 observations already converted to Sinco from CMO, no  need of conversion.
