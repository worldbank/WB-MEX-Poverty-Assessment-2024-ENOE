...
*<_relationharm_>
	...
	*as per the survey min age for labour being 15
	...
	replace head_count=1 if relationharm==1
	*there is a problem with hh being children under 15 in Q2 (the number of households affected is rather small)
...
*replace if not the usual hours in the week
	replace whours=p5b_thrs if p5a==2
...
/*<_healthins_> DOES NOT HAVE THIS QUESTION OF Q2
...
/*<_firmsize_l_2_> DOES NOT HAVE THIS QUESTION 
