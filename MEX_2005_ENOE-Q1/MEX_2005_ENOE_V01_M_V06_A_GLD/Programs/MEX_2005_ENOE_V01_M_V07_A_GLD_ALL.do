...
<_Program name_>				[MEX_2005_ENOE_V01_M_V06_A_GLD_ALL.do] </_Program name_>
...
* Date: [2022-03-D4] - [corrections variable wmonths, use of correct version for isic]
...
*keep folioh foliop salario t_loc fac clase1 clase2 ent ingocup;
sort foliop;
...
* harmonized output in a single file
	...
	use "`path_in_stata'/COE1T105.dta", clear
	...
	use "`path_in_stata'/COE2T105.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	* Overwrtwrite temp file
	...
	use "`path_in_stata'/SDEMT105.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	* Overwrtwrite temp file
	...
	use "`path_in_stata'/VIVT105.dta",clear
	drop p1-p3
	...
	* Overwrtwrite temp file
	...
	use "`path_in_stata'/HOGT105.dta", clear
...
***then second job
	...
	merge m:1 cmo using "`path_in_stata'/CMO_09_ISCO_08.dta", keep(master match) nogen
*Note: rename necessary to interpret cmo
	rename cmo cmo_2
	rename isco isco_2
...
*<_% KEEP VARIABLES - ALL_>
	...
	local includevars "emp_ppal tue_ppal mh_fil2 mh_col"
