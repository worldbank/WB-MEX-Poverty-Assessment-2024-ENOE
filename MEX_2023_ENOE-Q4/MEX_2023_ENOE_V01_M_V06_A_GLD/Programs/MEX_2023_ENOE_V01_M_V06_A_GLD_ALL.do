...
<_Program name_>				[MEX_2023_ENOE_V01_M_V06_A_GLD_ALL.do] </_Program name_>
<_Application_>					[STATA] <_Application_>
<_Author(s)_>					[The World Bank Jobs Group] </_Author(s)_>
<_Date created_>				2023-03-24 </_Date created_>
...
<_Data collection from_>		[XX/20XX] </_Data collection from_>
<_Data collection to_>			[XX/20XX] </_Data collection to_>
<_Source of dataset_> 			[Mexico NSO] </_Source of dataset_>
<_Sample size (HH)_> 			[XXXXX] </_Sample size (HH)_>
<_Sample size (IND)_> 			[XXXXX] </_Sample size (IND)_>
...
*Note: the dta. 2019- onwards have in var p3 observations already converted to Sinco from CMO, no  need of conversion.
