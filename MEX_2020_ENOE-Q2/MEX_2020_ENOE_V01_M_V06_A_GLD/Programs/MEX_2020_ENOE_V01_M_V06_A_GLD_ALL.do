...
<_Sample size (HH)_> 			[116309] </_Sample size (HH)_>
<_Sample size (IND)_> 			[409071] </_Sample size (IND)_>
...
* harmonized output in a single file
		use "`path_in_stata'/COE1T220.dta", clear
	...
	use "`path_in_stata'/COE2T220.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	* Overwrtwrite temp file
	...
	use "`path_in_stata'/SDEMT220.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	* Overwrtwrite temp file
	...
	use "`path_in_stata'/VIVT220.dta",clear
	drop p1-p3
	...
	* Overwrtwrite temp file
	...
	use "`path_in_stata'/HOGT220.dta", clear
