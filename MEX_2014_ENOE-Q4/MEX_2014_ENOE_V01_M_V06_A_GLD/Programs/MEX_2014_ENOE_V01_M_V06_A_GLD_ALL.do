...
<_Program name_>				[MEX_2014_ENOE_V01_M_V06_A_GLD_ALL.do] </_Program name_>
...
<_Data collection to_>			[05/2014] </_Data collection to_>
<_Source of dataset_> 			[Mexico NSO] </_Source of dataset_>
<_Sample size (HH)_> 			[106,164] </_Sample size (HH)_>
<_Sample size (IND)_> 			[396,438] </_Sample size (IND)_>
...
* Date: [2021-04-01] - [Check code and input variables]
...
*Note: the dta. 2014- onwards have in var p3 observations already converted to Sinco from CMO, no  need of conversion.
...
/*<_healthins_> Does not have this question for Q4 of this year
...
*<_union_> Does not have this question for Q4 for this year
...
*<_firmsize_l_2_> Does not have this question for Q4 of this year
