...
<_Program name_>				[MEX_2007_ENOE_V01_M_V03_A_GLD_ALL.do] </_Program name_>
...
*this variable has outliers starting in 85 to 168 hours of work, Changed the variable for Q2 of 2007 to p5c_thrs
	gen whours=p5c_thrs
*replace if not the usual hours in the week
	replace whours=p5c_thrs if p5==2
...
*<_contract_> Variable for contract on Q2 of 2007 is p3j
