...
<_Program name_>				[MEX_2016_ENOE_V01_M_V06_A_GLD_ALL.do] </_Program name_>
...
<_Data collection to_>			[05/2016] </_Data collection to_>
<_Source of dataset_> 			[Mexico NSO] </_Source of dataset_>
<_Sample size (HH)_> 			[107,030] </_Sample size (HH)_>
<_Sample size (IND)_> 			[390,065] </_Sample size (IND)_>
...
*Note: the dta. 2016- onwards have in var p3 observations already converted to Sinco from CMO, no  need of conversion.
...
/* <_subnatid1_prev_note>
	...
	gen subnatid1_prev = . // "9 - Distrito Federal" if subnatid1 == "9 - Ciudad de México"
